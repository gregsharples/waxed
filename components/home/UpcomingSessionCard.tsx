    ...
    >
      <View style={styles.dateContainer}>
        ...
        <Text style={styles.month}>
          {formatDate(new Date(session.date)).month}
        </Text>
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.time}>
          {formatDate(new Date(session.date)).time}
        </Text>
          ...
          {session.waveHeight && (
            <View style={styles.conditionItem}>
              ...
              <Text style={styles.conditionText}>
                {session.waveHeight.label}
              </Text>
            </View>
          )}
          {/* Add wind speed back if it's part of Session again, or remove this section */}
          {/* <View style={styles.conditionItem}>
